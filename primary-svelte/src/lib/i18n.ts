...
// JL note: Code only works server-side at the moment, so I've commented it out until we can refactor it to work both server-side and client-side
...
/** Temporary */
export function msg(text: string, opts?: StringDict) {
	if (opts) {
...
export const msgJs = msg;
export const msgMarked = msg;