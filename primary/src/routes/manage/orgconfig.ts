...
router.get('/editform', wrap(async (req, res) => {
	...
	let schema: Schema | undefined,
		...
		layout = `[
			...
			{ "type": "spacer" },
			{ "type": "multiselect", "label": "You can insert form elements of the following type:", "options": [ "header", "subheader", "spacer", "checkbox", "textblock", "counter", "multiselect", "slider", "derived", "import_data" ], "id": "yourIdsShouldBeCamelCase" },
