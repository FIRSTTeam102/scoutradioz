...
router.get('/', wrap(async (req, res, next) => {
	...
	// If user is signed in to an org, then store that so the page can handle a special case
	let originalOrgKey, originalUser;
	if (req.user && req.user.name !== 'default_user') {
