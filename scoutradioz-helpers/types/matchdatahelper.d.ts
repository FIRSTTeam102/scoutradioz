import { Utilities, MongoDocument, Match, TeamKey, AggRange } from '@firstteam102/scoutradioz-utilities';
export declare class MatchDataHelper {
     ...
     */
    fixDatumType(value: string | number | boolean, type: string): string | number | boolean;
    /**
     ...
     */
    calculateDerivedMetrics(org_key: string, event_year: number, matchData: MatchFormData): Promise<MatchFormData>;
    /**
     * @param {string} org_key Org key
     * @param {number} event_year Year of event
     ...
     */
    getModifiedMatchScoutingLayout(org_key: string, event_year: number, colCookie: string): Promise<MongoDocument[]>;
    /**
     ...
     */
    calculateAndStoreAggRanges(org_key: string, event_year: number, event_key: string): Promise<void>;
    /**
     ...
     */
    getUpcomingMatchData(event_key: string, team_key: string, org_key: string): Promise<UpcomingMatchData>;
    /**
     * Gets alliance stats
     ...
     */
    getAllianceStatsData(event_year: number, event_key: string, org_key: string, teams_list: string, cookies: any): Promise<AllianceStatsData>;
}
